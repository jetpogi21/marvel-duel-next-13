...
import { createDeck, deleteDecks, updateDeck } from "@/utils/api/DeckLibs";
...
export const GET = async (req: Request) => {
  ...
  data = reduceResult(data as any, [
    ...
    ["HeroSkill", "HeroSkills"], //Generated by GetLeftModelToReduce - GetLeftModelToReduce
  ]) as unknown as DeckModel[];
