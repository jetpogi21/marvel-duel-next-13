...
import { updateLockedDeck } from "@/app/api/locked-decks/route";
...
const findOptions: FindOptions<typeof LockedDeck> = {//Generated by GenerateIncludeOption
...
export const GET = async (
  ...
  const findOptionsCopy: FindOptions<typeof LockedDeck> = cloneDeep(findOptions);
