...
import { updateCardUnity } from "@/app/api/card-unities/route";
...
export const GET = async (
  ...
  const id = params.id;
  return genericGetOne(ModelObject, id, findOptionsCopy);
};
...
export const PUT = async (
  ...
  try {
    ...
    return NextResponse.json({
      status: "success", //Generated by GetAllRelatedModelKeyValue //Generated by GetRelatedModelKeyValue - GetRelatedModelKeyValue
      CardUnityCards: createdCardUnityCards,
    });
  } catch (err) {
    t.rollback();
