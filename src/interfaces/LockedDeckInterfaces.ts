...
export interface LockedDeckFormikShape
  extends Omit<
    LockedDeckModel,
    "slug" | "createdAt" | "updatedAt" | "LockedDeckCards" //Generated by GetRelatedPluralizedModelName - RelatedPluralizedModelName
  > {
  touched: boolean;
  index: number;
}
...
export interface LockedDeckUpdatePayload
  extends Partial<LockedDeckCardUpdatePayload> {
...
export interface LockedDeckFormUpdatePayload
  extends Omit<LockedDeckFormikShape, "touched" | "index">, //Generated by GetModelUpdatePayload - ModelUpdatePayload
