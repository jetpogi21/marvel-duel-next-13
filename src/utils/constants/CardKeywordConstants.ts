...
export const VERBOSE_MODEL_NAME = "Card Keyword";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Card Keywords";
export const DEFAULT_SORT_BY = "name";
export const DEFAULT_FILTERS: Partial<CardKeywordFormikFilter> = {
