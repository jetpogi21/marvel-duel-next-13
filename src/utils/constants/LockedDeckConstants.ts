...
import { LockedDeckFormikFilter } from "@/interfaces/LockedDeckInterfaces";
import { convertDateToYYYYMMDD } from "@/utils/utilities";

export const MODEL_NAME = "LockedDeck";
export const TABLE_NAME = "lockeddecks";
export const PLURALIZED_MODEL_NAME = "LockedDecks";
export const VERBOSE_MODEL_NAME = "Locked Deck";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Locked Decks";
export const DEFAULT_SORT_BY = "name";
export const DEFAULT_FILTERS: Partial<LockedDeckFormikFilter> = {
