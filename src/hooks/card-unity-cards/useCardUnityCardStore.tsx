...
import { DEFAULT_SORT_BY } from "@/utils/constants/CardUnityCardConstants";
...
type State = {
  ...
  currentData: CardUnityCardFormikShape[];
  isUpdating: boolean;
  sort: string;
};
...
type Actions = {
  ...
  setCurrentData: (item: CardUnityCardFormikShape[]) => void;
  setIsUpdating: (isUpdating: boolean) => void;
  setSort: (sort: string) => void;
};

// Create your store, which includes both state and (optionally) actions
const useCardUnityCardStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
