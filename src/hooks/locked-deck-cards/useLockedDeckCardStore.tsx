...
import { DEFAULT_SORT_BY } from "@/utils/constants/LockedDeckCardConstants";
...
type State = {
  ...
  currentData: LockedDeckCardFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
};
...
type Actions = {
  ...
  setCurrentData: (item: LockedDeckCardFormikShape[]) => void;
...
const useLockedDeckCardStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
