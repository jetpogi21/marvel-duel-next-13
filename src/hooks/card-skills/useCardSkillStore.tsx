...
import { DEFAULT_SORT_BY } from "@/utils/constants/CardSkillConstants";
...
type State = {
  ...
  currentData: CardSkillFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
};
...
type Actions = {
  ...
  setCurrentData: (item: CardSkillFormikShape[]) => void;
...
const useCardSkillStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
