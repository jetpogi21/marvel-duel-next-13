...
import { CardUnityModel } from "@/interfaces/CardUnityInterfaces";
import { DEFAULT_SORT_BY } from "@/utils/constants/CardUnityConstants";
...
type Actions = {
  ...
  setCurrentData: (item: CardUnityModel[]) => void;
...
const useCardUnityStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
