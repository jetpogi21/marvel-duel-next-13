...
import { DEFAULT_SORT_BY } from "@/utils/constants/CardKeywordConstants";
...
type State = {
  ...
  currentData: CardKeywordFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
};
...
type Actions = {
  ...
  setCurrentData: (item: CardKeywordFormikShape[]) => void;
...
const useCardKeywordStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
