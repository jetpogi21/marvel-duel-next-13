...
import { LockedDeckFormUpdatePayload, LockedDeckModel } from "@/interfaces/LockedDeckInterfaces";
...
export const getLockedDeck = async ({ queryKey }: { queryKey: [string, string] }) => {
