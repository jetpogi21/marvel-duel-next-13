...
import { LockedDeckModel } from "@/interfaces/LockedDeckInterfaces";
import { DEFAULT_SORT_BY } from "@/utils/constants/LockedDeckConstants";
...
type Actions = {
  ...
  setCurrentData: (item: LockedDeckModel[]) => void;
...
const useLockedDeckStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
