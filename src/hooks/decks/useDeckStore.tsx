...
import { DEFAULT_SORT_BY } from "@/utils/constants/DeckConstants";
...
type Actions = {
  ...
  setCurrentData: (item: DeckFormikShape[]) => void;
  setIsUpdating: (isUpdating: boolean) => void;
  setSort: (sort: string) => void;
};

// Create your store, which includes both state and (optionally) actions
const useDeckStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
