...
const LockedDeckCardDataTable: React.FC = () => {
  //URL States
  ...
  const getCurrentData = (page: number) => {
    return [
      ...lockedDeckCardData!.pages[page - 1].rows.map((item) => ({
        ...item
      })),
    ];
  };
  ...
  const lockedDeckCardTable = useReactTable<LockedDeckCardModel>({
    data: currentData,
...
export default LockedDeckCardDataTable;
