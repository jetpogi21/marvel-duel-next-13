...
import { LockedDeckRowActions } from "@/components/locked-decks/LockedDeckRowActions";

export const LockedDeckColumns: ColumnDef<LockedDeckModel>[] = [
  {
    id: "select",
    header: ({ table }) => {
...
enableSorting: true
},
  {
    ...
    cell: (cell) => <LockedDeckRowActions cell={cell} />,
  },
];
