...
import { CardUnityRowActions } from "@/components/card-unities/CardUnityRowActions";

export const CardUnityColumns: ColumnDef<CardUnityModel>[] = [
  {
    id: "select",
    header: ({ table }) => {
  ...
  },
  {
    ...
    cell: (cell) => <CardUnityRowActions cell={cell} />,
  },
];
